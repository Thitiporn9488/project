...
<body>
    ...
    <form action="{{action('IncubatorController@update', $id)}}" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input name="id_in" type="text" class="form-control" placeholder="ID โรงบ่ม" value="{{$incub->id_in}}">
            </div>
            <div class="form-group">
                <label>ชื่อโรงบ่ม</label>
                <input name="name" type="text" class="form-control" placeholder="ชื่อโรงบ่ม" value="{{$incub->name}}">
            </div>
            <div class="form-group">
                <label>ที่อยู่</label>
