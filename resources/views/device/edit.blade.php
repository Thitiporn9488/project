...
<div class="container">
 ...
 <form action="{{action('DeviceController@update', $id)}}" method="POST">
...
{{csrf_field()}}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="id_device" type="text" class="form-control" placeholder="ID โรงบ่ม" value="{{$device->id_device}}" >
                    </div>
                    <div class="form-group">
                        <label>key</label>
                        <input name="key" type="text" class="form-control" placeholder="ชื่อโรงบ่ม" value="{{$device->key}}" >
                    </div>
